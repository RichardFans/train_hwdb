...
import effnetv2.autoaugment as autoaugment
import effnetv2.preprocess_legacy as preprocess_legacy
    ...
    if is_training:
        ...
        if 'autoaug' in augname or 'randaug' in augname:
            ...
            image = tf.cast(tf.clip_by_value(
                image, 0.0, 255.0), dtype=tf.uint8)
